            ...
            execute: function () {
              ...
              t("LeverController", (d = x("LeverController"), m = b(s), v = b(s), f = b(s), d((w = i((y = function (t) {
                ...
                return a.onLoad = function () {
                  ...
                  if (!this.isTouched) {
                    var i = function (i, n) {
                      return void 0 === n && (n = i), l(i).to(t.animationDuration, {
                        position: new u(i.position.x, t.maxY, 0)
                      }).to(t.animationDuration, {
                        position: new u(i.position.x, t.minY, 0)
                      }).to(t.animationDuration, {
                        position: new u(i.position.x, n.position.y, 0)
                      });
                    };
...
//# sourceMappingURL=48b40d986ca6b9db082967defc7b6cda5af2bd6b.js.map